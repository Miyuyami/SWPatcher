...
namespace SWPatcher.Forms
{
    partial class MainForm
    {
        ...
        private void SetSWPath()
        {
            ...
            {
                string keyPath = @"SOFTWARE\HanPurple\J_SW";
                if (System.Environment.Is64BitOperatingSystem)
                    keyPath = @"SOFTWARE\WOW6432Node\HanPurple\J_SW";
                try
                {
                    folderDialog.SelectedPath = (string)Microsoft.Win32.Registry.GetValue(Microsoft.Win32.Registry.LocalMachine.Name + "\\" + keyPath, "folder", System.Environment.GetFolderPath(Environment.SpecialFolder.Desktop));
                }
                catch (Exception ex)
                {
